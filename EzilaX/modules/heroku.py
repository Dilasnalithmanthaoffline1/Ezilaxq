...
from EzilaX import telethn as borg, HEROKU_APP_NAME, HEROKU_API_KEY, OWNER_ID
from EzilaX.events import register
from EzilaX.function.heroku_helper import HerokuHelper
...
async def dyno_usage(dyno):
    ...
    return await die.edit(
        "**Dyno Usage 📊**:\n\n"
        f" -> `Dyno usage for`  **SLNinjaBotbot **:\n"
...
async def restart_bot(dyno):
    ...
    if dyno.sender_id == OWNER_ID:
        ...
        return await dyno.reply("SLNinjaBotbot will be restarted..."
         )
